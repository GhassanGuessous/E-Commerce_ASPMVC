...
namespace E_Commerce.CurrencyConverter {
    using System.Data;
    ...
    public interface ConverterSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        E_Commerce.CurrencyConverter.ConvertDataTableColumnResponse ConvertDataTableColumn(E_Commerce.CurrencyConverter.ConvertDataTableColumnRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ConvertDataTableColumn", ReplyAction="*")]
        System.Threading.Tasks.Task<E_Commerce.CurrencyConverter.ConvertDataTableColumnResponse> ConvertDataTableColumnAsync(E_Commerce.CurrencyConverter.ConvertDataTableColumnRequest request);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ConverterSoapChannel : E_Commerce.CurrencyConverter.ConverterSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ConverterSoapClient : System.ServiceModel.ClientBase<E_Commerce.CurrencyConverter.ConverterSoap>, E_Commerce.CurrencyConverter.ConverterSoap {
        ...
        E_Commerce.CurrencyConverter.ConvertDataTableColumnResponse E_Commerce.CurrencyConverter.ConverterSoap.ConvertDataTableColumn(E_Commerce.CurrencyConverter.ConvertDataTableColumnRequest request) {
        ...
        public void ConvertDataTableColumn(ref System.Data.DataSet ds, int TableIndex, string ColumnName, string FromCurrency, string ToCurrency) {
            E_Commerce.CurrencyConverter.ConvertDataTableColumnRequest inValue = new E_Commerce.CurrencyConverter.ConvertDataTableColumnRequest();
            inValue.ds = ds;
            inValue.TableIndex = TableIndex;
            inValue.ColumnName = ColumnName;
            inValue.FromCurrency = FromCurrency;
            inValue.ToCurrency = ToCurrency;
            E_Commerce.CurrencyConverter.ConvertDataTableColumnResponse retVal = ((E_Commerce.CurrencyConverter.ConverterSoap)(this)).ConvertDataTableColumn(inValue);
            ds = retVal.ds;
        }
        
        public System.Threading.Tasks.Task<E_Commerce.CurrencyConverter.ConvertDataTableColumnResponse> ConvertDataTableColumnAsync(E_Commerce.CurrencyConverter.ConvertDataTableColumnRequest request) {
